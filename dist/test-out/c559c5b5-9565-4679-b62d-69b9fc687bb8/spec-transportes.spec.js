...
\r
          <div class="row g-3">\r
            ...
            <div class="col-md-6">\r
              ...
              <select class="form-select" formControlName="residuoId">\r
                <option *ngFor="let r of residuos" [value]="r.id">{{ r.name }}</option>\r
              </select>\r
            </div>\r
            <div class="col-md-6">\r
    ...
    TransporteService = class TransporteService2 {
      ...
      updateTransporte(t) {
        ...
        const payload = {
          ...
          arrivalTime: t.fechaLlegada,
          trackingNumber: t.guia,
          items: Array.isArray(t.items) ? t.items.map((item) => ({
    ...
    TransporteComponent = class TransporteComponent2 {
      ...
      onSave() {
        ...
        if (new Date(this.form.value.fechaLlegada) < new Date(this.form.value.fechaSalida)) {
          this.toastr.error("La fecha de llegada no puede ser anterior a la de salida", "Validaci\xF3n");
          return;
        }
...
// src/app/pages/transporte/transportes.spec.ts
var require_transportes_spec = __commonJS({
  "src/app/pages/transporte/transportes.spec.ts"(exports) {
    init_tslib_es6();
    init_testing();
    init_transporte3();
    init_forms();
    ...
    var MockRouterLinkActive = class MockRouterLinkActive {
    };
    MockRouterLinkActive = __decorate([
      Directive({
...
export default require_transportes_spec();
...
@angular/animations/fesm2022/animations.mjs:
   ...
   *)
*/
//# sourceMappingURL=spec-transportes.spec.js.map
