...
// angular:jit:template:src\app\pages\registro-residuos\registro-residuos.html
var registro_residuos_default;
var init_registro_residuos = __esm({
  "angular:jit:template:src\\app\\pages\\registro-residuos\\registro-residuos.html"() {
    registro_residuos_default = `<div class="d-flex vh-100 overflow-hidden">\r
\r
...
\r
  <main class="flex-grow-1 overflow-auto p-4">\r
    <div class="d-flex justify-content-between align-items-center mb-4">\r
      <div>\r
        <h2 class="h3 mb-1">Registro de Residuos</h2>\r
        <small class="text-muted">\r
          Registra y clasifica los residuos generados en las obras\r
        </small>\r
      </div>\r
    </div>\r
\r
    <div class="card mb-5 shadow-sm">\r
      <div class="card-body">\r
        <h5 class="card-title">\r
          <i class="bi bi-box-seam me-2"></i>Nuevo Registro de Residuo\r
        </h5>\r
        <small class="text-muted d-block mb-4">\r
          Completa la informaci\xF3n del residuo generado\r
        </small>\r
\r
        <div class="row g-3">\r
          <!-- Servicio de Transporte -->\r
          <div class="col-md-6">\r
            <label class="form-label">Servicio de Transporte</label>\r
            <select\r
              class="form-select"\r
              [(ngModel)]="servicioSeleccionado"\r
              (ngModelChange)="onSeleccionServicio()"\r
            >\r
              <option [ngValue]="0" disabled>Selecciona el servicio</option>\r
              <option *ngFor="let tr of transportes" [ngValue]="tr.id">\r
                Servicio N\xB0{{ tr.id }}\r
              </option>\r
            </select>\r
          </div>\r
\r
          <!-- Tipo de Residuo (deshabilitado) -->\r
          <div class="col-md-6">\r
            <label class="form-label">Tipo de Residuo</label>\r
            <input type="text" class="form-control" [value]="tipoResiduoSeleccionado" disabled />\r
          </div>\r
\r
          <!-- Cantidad -->\r
          <div class="col-md-6">\r
            <label class="form-label">Cantidad</label>\r
            <input\r
              type="number"\r
              class="form-control"\r
              [(ngModel)]="registro.items[0].quantity"\r
              min="0"\r
              required\r
            />\r
          </div>\r
\r
          <!-- Unidad de medida -->\r
          <div class="col-md-6">\r
            <label class="form-label">Unidad de Medida</label>\r
            <input\r
              type="text"\r
              class="form-control"\r
              [(ngModel)]="unidadSeleccionada"\r
              placeholder="Ej: m\xB3, kg, etc."\r
            />\r
          </div>\r
\r
          <!-- Obra Asociada -->\r
          <div class="col-md-6">\r
            <label class="form-label">Obra Asociada</label>\r
            <select\r
              class="form-select"\r
              [(ngModel)]="registro.workSiteId"\r
              name="obra"\r
            >\r
              <option value="0" disabled selected>Selecciona una obra</option>\r
              <option *ngFor="let obra of obras" [value]="obra.id">{{ obra.name }}</option>\r
            </select>\r
          </div>\r
\r
          <!-- Responsable (deshabilitado) -->\r
          <div class="col-md-6">\r
            <label class="form-label">Responsable</label>\r
            <input type="text" class="form-control" [value]="responsableNombreSeleccionado" disabled />\r
          </div>\r
\r
          <!-- Conductor -->\r
          <div class="col-md-6">\r
            <label class="form-label">Conductor</label>\r
            <input type="text" class="form-control" [value]="conductorSeleccionado" disabled />\r
          </div>\r
\r
          <!-- Patente -->\r
          <div class="col-md-6">\r
            <label class="form-label">Patente</label>\r
            <input type="text" class="form-control" [value]="patenteSeleccionada" disabled />\r
          </div>\r
\r
          <!-- Gu\xEDa -->\r
          <div class="col-md-6">\r
            <label class="form-label">N\xB0 Gu\xEDa</label>\r
            <input type="text" class="form-control" [value]="guiaSeleccionada" disabled />\r
          </div>\r
\r
          <!-- Observaciones -->\r
          <div class="col-12">\r
            <label class="form-label">Observaciones</label>\r
            <textarea\r
              class="form-control"\r
              rows="3"\r
              placeholder="Descripci\xF3n adicional\u2026"\r
              [(ngModel)]="registro.comments"\r
            ></textarea>\r
          </div>\r
\r
          <!-- Fotos -->\r
          <div class="col-12">\r
            <label class="form-label">Evidencia Fotogr\xE1fica (Opcional)</label>\r
            <div class="upload-dropzone">\r
              <i class="bi bi-camera fs-1"></i>\r
              <p class="mt-2">Arrastra las im\xE1genes aqu\xED o haz clic para seleccionar</p>\r
              <button\r
                class="btn btn-outline-primary btn-sm"\r
                type="button"\r
                (click)="fileInput.click()"\r
              >\r
                Seleccionar Archivos\r
              </button>\r
              <input\r
                #fileInput\r
                type="file"\r
...
\r
          ...
          <div class="col-12 text-end mt-3">\r
            <button\r
              ...
              (click)="submit()"\r
            >\r
              <i class="bi bi-plus-lg me-1"></i>Registrar Residuo\r
            </button>\r
...
\r
    <!-- Lista de recientes -->\r
    <div class="card shadow-sm">\r
      <div class="card-body">\r
        <h5 class="card-title mb-1">Residuos Registrados Recientemente</h5>\r
        <p class="text-muted mb-4 small">\xDAltimos registros de residuos en el sistema</p>\r
        <ul class="list-unstyled mb-0">\r
          <li *ngFor="let registro of recientes" class="mb-4">\r
            <div class="d-flex justify-content-between align-items-center">\r
              <div class="d-flex align-items-center">\r
                <div class="bg-light rounded-circle p-3 me-3 d-flex align-items-center justify-content-center" style="width: 60px; height: 60px;">\r
                  <i class="bi bi-box-seam fs-3 text-success"></i>\r
                </div>\r
                <div>\r
                  <div class="fw-bold">\r
                    {{\r
                      obtenerNombreTipo(registro.items[0].item.id) || 'Tipo desconocido'\r
                    }} -\r
                    {{\r
                      registro.items[0].quantity\r
                    }}\r
                    {{\r
                      obtenerUnidadPorTipo(registro.items[0].item.id)\r
                    }}\r
                  </div>\r
                  <div class="text-muted small">\r
                    {{\r
                      obtenerNombreObra(registro.workSiteId)\r
                    }} \u2022 {{\r
                      obtenerNombreResponsable(registro.carrierId)\r
                    }}\r
                  </div>\r
                  <div class="text-muted small" *ngIf="registro.comments">\r
                    {{ registro.comments }}\r
                  </div>\r
                </div>\r
              </div>\r
              <div class="text-end">\r
                <span class="badge bg-light text-dark border">Registrado</span>\r
              </div>\r
            </div>\r
            <hr *ngIf="registro !== recientes[recientes.length - 1]" />\r
          </li>\r
        </ul>\r
      </div>\r
    </div>\r
...
// angular:jit:style:src\app\pages\registro-residuos\registro-residuos.css
var registro_residuos_default2;
var init_registro_residuos2 = __esm({
  "angular:jit:style:src\\app\\pages\\registro-residuos\\registro-residuos.css"() {
    registro_residuos_default2 = "/* src/app/pages/registro-residuos/registro-residuos.css */\n.sidebar {\n  width: 240px;\n  background-color: #16a249;\n  color: white;\n  padding: 2rem 1rem;\n  display: flex;\n  flex-direction: column;\n}\n.logo-icon {\n  font-size: 1.5rem;\n}\n.brand {\n  display: flex;\n  align-items: center;\n  gap: 0.5rem;\n  margin-bottom: 2rem;\n}\n.brand-name {\n  font-weight: 700;\n  font-size: 1.2rem;\n}\n.nav-section {\n  flex: 1;\n}\n.nav-section-title {\n  text-transform: uppercase;\n  font-size: 0.75rem;\n  opacity: 0.7;\n  margin: 1rem 0 0.5rem;\n}\n.nav-link {\n  color: white;\n  font-size: 0.9rem;\n  display: flex;\n  align-items: center;\n  gap: 0.5rem;\n  padding: 0.25rem 0;\n  text-decoration: none;\n  transition: opacity .2s;\n}\n.nav-link.active,\n.nav-link:hover {\n  opacity: 0.8;\n}\n.obra-card {\n  border-radius: .75rem;\n}\n.obra-card h5 {\n  font-weight: 600;\n}\n.obra-card .badge {\n  font-size: .75rem;\n  text-transform: none;\n  padding: .4em .8em;\n}\n.progress {\n  background-color: #e9ecef;\n}\n.progress-bar {\n  transition: width .6s ease;\n}\n.upload-dropzone {\n  border: 2px dashed #ced4da;\n  border-radius: .5rem;\n  padding: 2rem;\n  text-align: center;\n  cursor: pointer;\n  color: #6c757d;\n}\n.upload-dropzone:hover {\n  background-color: #f8f9fa;\n}\n.nav-link.active {\n  background-color: rgba(255, 255, 255, 0.1);\n}\n.snack-success {\n  background-color: #4caf50 !important;\n  color: #fff !important;\n}\n.snack-error {\n  background-color: #f44336 !important;\n  color: #fff !important;\n}\n/*# sourceMappingURL=registro-residuos.css.map */\n";
  }
});
...
// src/app/pages/registro-residuos/registro-residuos.service.ts
var RegistroResiduosService;
var init_registro_residuos_service = __esm({
  "src/app/pages/registro-residuos/registro-residuos.service.ts"() {
    "use strict";
    init_tslib_es6();
    init_core();
    ...
    init_operators();
    init_environment();
    RegistroResiduosService = class RegistroResiduosService2 {
      http;
      carriersUrl = `${environment.apiUrl}/carriers`;
      itemsUrl = `${environment.apiUrl}/items`;
      workSitesUrl = `${environment.apiUrl}/worksites`;
      inventoriesUrl = `${environment.apiUrl}/inventories`;
      constructor(http) {
        this.http = http;
      }
      getCarriers() {
      ...
      getWorkSites() {
        return this.http.get(this.workSitesUrl);
      }
      getTransportes() {
        return this.http.get(`${environment.apiUrl}/carriers`);
      }
      createRegistro(registro, conductor, responsable, patente, guia, unidad) {
        const payload = {
          workSite: { id: registro.workSiteId },
          inventoryStatus: { id: registro.inventoryStatusId },
          carrier: { id: registro.carrierId },
          transporte: registro.transporteId ? { id: registro.transporteId } : void 0,
      ...
      actualizarEstadoTransporte(transporteId, nuevoEstadoId) {
        const url = `${environment.apiUrl}/carriers/${transporteId}`;
        return this.http.get(url).pipe(switchMap((carrier) => {
    ...
    RegistroResiduosService = __decorate([
      Injectable({ providedIn: "root" })
    ], RegistroResiduosService);
  }
});

// src/app/pages/registro-residuos/registro-residuos.ts
var RegistroResiduosComponent;
var init_registro_residuos3 = __esm({
  "src/app/pages/registro-residuos/registro-residuos.ts"() {
    "use strict";
    init_tslib_es6();
    init_registro_residuos();
    init_registro_residuos2();
    init_core();
    init_common();
    init_forms();
    init_router();
    init_snack_bar();
    init_registro_residuos_service();
    RegistroResiduosComponent = class RegistroResiduosComponent2 {
      svc;
      snack;
      router;
      obras = [];
      ...
      ngOnInit() {
        this.svc.getCarriers().subscribe({
          ...
          error: () => this.snack.open("Error cargando responsables", "Cerrar", { duration: 3e3 })
        });
        this.svc.getItems().subscribe({
          next: (items) => this.tipos = items,
          error: () => this.snack.open("Error cargando tipos de residuo", "Cerrar", { duration: 3e3 })
        });
        this.svc.getWorkSites().subscribe({
          next: (ws) => this.obras = ws,
          error: () => this.snack.open("Error cargando obras", "Cerrar", { duration: 3e3 })
        });
        this.svc.getTransportes().subscribe({
          next: (t) => this.transportes = t.filter((tr) => tr.status?.id === 1),
          error: () => {
            this.snack.open("Error cargando servicios de transporte", "Cerrar", { duration: 3e3 });
          }
        });
        this.svc.getRegistros().subscribe({
          ...
          error: () => {
            this.snack.open("Error cargando registros", "Cerrar", { duration: 3e3 });
          }
        });
      }
      onTipoYCantidadChange() {
      ...
      submit() {
        ...
        this.svc.createRegistro(this.registro, this.conductorSeleccionado, this.responsableNombreSeleccionado, this.patenteSeleccionada, this.guiaSeleccionada, this.unidadSeleccionada).subscribe({
          next: () => {
            if (this.registro.transporteId) {
              this.svc.actualizarEstadoTransporte(this.registro.transporteId, 3).subscribe({
                next: () => {
                  ...
                  this.recientes.unshift(__spreadValues({}, this.registro));
      ...
      getTipoNombreFromRegistro(r) {
        const itemId = r.items && r.items.length > 0 ? r.items[0].item.id : void 0;
      ...
      obtenerUnidadPorTipo(id) {
        const tipo = this.tipos.find((t) => t.id === id);
        return tipo?.unit || "u";
      }
      obtenerNombreObra(id) {
        const obra = this.obras.find((o) => o.id === id);
        return obra?.name || "Obra desconocida";
      }
      ...
      static ctorParameters = () => [
        { type: RegistroResiduosService },
        { type: MatSnackBar },
        { type: Router }
      ];
    };
    RegistroResiduosComponent = __decorate([
      Component({
        ...
        template: registro_residuos_default,
        styles: [registro_residuos_default2]
      })
    ], RegistroResiduosComponent);
  }
});

// src/app/pages/registro-residuos/registro-residuos.spec.ts
var require_registro_residuos_spec = __commonJS({
  "src/app/pages/registro-residuos/registro-residuos.spec.ts"(exports) {
    init_testing();
    init_registro_residuos3();
    init_registro_residuos_service();
    init_router();
    init_snack_bar();
    init_esm();
    describe("RegistroResiduosComponent", () => {
      ...
      it("deber\xEDa crear el componente", () => {
        expect(component).toBeTruthy();
      });
      it("deber\xEDa cargar datos en ngOnInit", fakeAsync(() => {
      ...
      it("deber\xEDa mostrar error si no se selecciona responsable", () => {
        const snackSpy = spyOn(component["snack"], "open");
        component.registro = __spreadProps(__spreadValues({}, component.registro), {
          carrierId: 0,
          workSiteId: 1,
      ...
      it("deber\xEDa mostrar error si no se selecciona obra", () => {
        const snackSpy = spyOn(component["snack"], "open");
        component.registro = __spreadProps(__spreadValues({}, component.registro), {
          carrierId: 1,
          workSiteId: 0,
      ...
      it("deber\xEDa mostrar error si no hay tipo/cantidad", () => {
        const snackSpy = spyOn(component["snack"], "open");
        component.registro = __spreadProps(__spreadValues({}, component.registro), {
          carrierId: 1,
          workSiteId: 1,
      ...
      it("deber\xEDa registrar correctamente sin transporte asociado", fakeAsync(() => {
        const snackSpy = spyOn(component["snack"], "open");
        component.registro = {
          carrierId: 1,
          workSiteId: 1,
      ...
      it("deber\xEDa actualizar transporte si est\xE1 presente", fakeAsync(() => {
        const snackSpy = spyOn(component["snack"], "open");
        component.registro = {
          carrierId: 1,
          workSiteId: 1,
      ...
      it("deber\xEDa manejar error al registrar", fakeAsync(() => {
        const snackSpy = spyOn(component["snack"], "open");
        component.registro = {
          carrierId: 1,
          workSiteId: 1,
      ...
      it("deber\xEDa asignar valores al seleccionar servicio", () => {
      ...
      it("logout debe limpiar sesi\xF3n y redirigir a login", () => {
...
export default require_registro_residuos_spec();
//# sourceMappingURL=spec-registro-residuos.spec.js.map
