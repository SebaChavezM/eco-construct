...
var init_testing3 = __esm({
  "node_modules/@angular/router/fesm2022/testing.mjs"() {
    ...
    RouterTestingModule = class _RouterTestingModule {
      ...
      static \u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "20.0.0", ngImport: core_exports, type: _RouterTestingModule, deps: [], target: FactoryTarget.NgModule });
      static \u0275mod = \u0275\u0275ngDeclareNgModule({ minVersion: "14.0.0", version: "20.0.0", ngImport: core_exports, type: _RouterTestingModule, exports: [RouterModule] });
      static \u0275inj = \u0275\u0275ngDeclareInjector({ minVersion: "12.0.0", version: "20.0.0", ngImport: core_exports, type: _RouterTestingModule, providers: [
        ROUTER_PROVIDERS,
        provideLocationMocks(),
    ...
    \u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.0.0", ngImport: core_exports, type: RouterTestingModule, decorators: [{
      type: NgModule,
      args: [{
    ...
    RootFixtureService = class _RootFixtureService {
      ...
      static \u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "20.0.0", ngImport: core_exports, type: _RootFixtureService, deps: [], target: FactoryTarget.Injectable });
      static \u0275prov = \u0275\u0275ngDeclareInjectable({ minVersion: "12.0.0", version: "20.0.0", ngImport: core_exports, type: _RootFixtureService, providedIn: "root" });
    };
    \u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.0.0", ngImport: core_exports, type: RootFixtureService, decorators: [{
      type: Injectable,
      args: [{ providedIn: "root" }]
    }] });
...
var require_residuos_spec = __commonJS({
  "src/app/pages/transporte/residuos.spec.ts"(exports) {
    ...
    describe("TransporteComponent", () => {
      ...
      it("deber\xEDa cargar transportes y residuos en ngOnInit", () => {
        ...
        const mockResiduos = [{ id: 1, name: "Metal" }];
      ...
      it("deber\xEDa mostrar error si falla carga de transportes", () => {
      ...
      it("no deber\xEDa registrar si el formulario es inv\xE1lido", () => {
      ...
      it("deber\xEDa abrir el modal de detalle correctamente", () => {
        const transporte = {
          ...
          destino: "Relleno",
          patente: "XYZ-9999",
          fechaSalida: "2025-07-14T08:00",
          fechaLlegada: "2025-07-14T09:00",
      ...
      it("logout deber\xEDa limpiar storage y navegar al login", () => {
      ...
      it("deber\xEDa devolver nombre de residuo por ID", () => {
        component.residuos = [{ id: 1, name: "Papel" }];
        const name = component.getResiduoNombrePorId(1);
        expect(name).toBe("Papel");
      });
      it('deber\xEDa devolver "(Desconocido)" si no encuentra el residuo', () => {
        component.residuos = [];
